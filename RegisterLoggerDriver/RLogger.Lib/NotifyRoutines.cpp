...
NTSTATUS OnRegistryNotify(PVOID context, PVOID arg1, PVOID arg2)
{
	...
	{
		KdPrint(("[INFO]: Uninteresting process, id: %u", pid));
	...
	{
		KdPrint(("[INFO]: Unable to open file"));
	...
	if (!NT_SUCCESS(status)) 
	{
		KdPrint(("[INFO]: Unable to write to file"));
